...
contextBridge.exposeInMainWorld("zeno", {
  ...
  onWhisperStatus: (callback) => ipcRenderer.on("whisper:status", (_event, status) => callback(status)),
  ...
  onAgentStep: (callback) => ipcRenderer.on("agent:step", (_event, payload) => callback(payload)),
  overlayHide: () => ipcRenderer.invoke("overlay:hide"),
  overlayResize: (height) => ipcRenderer.invoke("overlay:resize", height),
  overlayOpenMain: () => ipcRenderer.invoke("overlay:open-main"),
  onOverlayActivate: (callback) => ipcRenderer.on("overlay:activate", callback),
  onOverlaySoftHide: (callback) => ipcRenderer.on("overlay:soft-hide", callback),
